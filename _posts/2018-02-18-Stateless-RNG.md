...
![lcg_sequence]({{site.url}}{{site.baseurl}}/images/2018-02-18/lcg_10000.png) 

Looks random enough right? Well, let's try to generate a 200x200 image, where the columns use consecutive seeds 

![lcg_mat]({{site.url}}{{site.baseurl}}/images/2018-02-18lcg_matrix.png)
...
![rdtsc_no_state]({{site.url}}{{site.baseurl}}/images/2018-02-18lcg_no_state.png) 
...
![rdtsc_direct]({{site.url}}{{site.baseurl}}/images/2018-02-18rdtsc_direct.png) 
...
![rdtsc_matrix]({{site.url}}{{site.baseurl}}/images/2018-02-18rng/rdtsc_matrix.png)
