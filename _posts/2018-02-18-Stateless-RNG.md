...
![lcg_sequence]({{site.url}}{{site.baseurl}}/images/postImages/2018-02-18/lcg10000.png) 

Looks random enough right? Well, let's try to generate a 200x200 image, where the columns use consecutive seeds 

![lcg_mat]({{site.url}}{{site.baseurl}}/images/postImages/2018-02-18/lcgMatrix.png)
...
![rdtsc_no_state]({{site.url}}{{site.baseurl}}/images/postImages/2018-02-18/lcgNoState.png) 
...
![rdtsc_direct]({{site.url}}{{site.baseurl}}/images/postImages/2018-02-18/rdtscDirect.png) 
...
![rdtsc_matrix]({{site.url}}{{site.baseurl}}/images/postImages/2018-02-18rng/rdtscMatrix.png)
